...
<head>
  ...
  <meta name="description" content="DevNation - Empowering students to innovate, collaborate, and grow in the ever-evolving world of technology.">
  <meta name="keywords" content="DevNation, student association, technology, innovation, collaboration, learning">
  <meta name="author" content="DevNation">
  <title>About DevNation</title>
      ...
      <div class="container pt-10 pt-md-14 text-center">
        <div class="row">
          <div class="col-xl-6 mx-auto">
            ...
            <p class="lead fs-lg mb-0">Empowering students to innovate, collaborate, and grow in the ever-evolving world of technology.</p>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
      ...
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
          <div class="col-lg-6 position-relative order-lg-2">
            ...
            <div class="overlap-grid overlap-grid-2">
              <div class="item">
                <figure class="rounded shadow"><img src="assets/img/photos/about2.jpg" srcset="./assets/img/photos/about2@2x.jpg 2x" alt="DevNation Event"></figure>
              </div>
              <div class="item">
                <figure class="rounded shadow"><img src="assets/img/photos/about3.jpg" srcset="./assets/img/photos/about3@2x.jpg 2x" alt="DevNation Workshop"></figure>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <p class="lead fs-lg">We are a dynamic student-led association dedicated to fostering innovation, collaboration, and growth in the world of technology.</p>
            <p class="mb-6">At DevNation, we believe in the power of practical learning, creativity, and teamwork. Our mission is to empower students with the skills and knowledge they need to thrive in the rapidly evolving tech industry.</p>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <p class="lead fs-lg pe-lg-5">DevNation creates a dynamic ecosystem where students can learn, innovate, and grow their tech skills.</p>
            <p>Our approach combines practical workshops, collaborative projects, and industry insights to prepare students for the challenges of the tech world. We believe in learning by doing, fostering creativity, and building a strong community of tech enthusiasts.</p>
            <p class="mb-6">Through our events and initiatives, we aim to bridge the gap between academic learning and industry requirements, ensuring our members are well-equipped for their future careers in technology.</p>
      ...
      <div class="container pt-16 pb-14 pb-md-0">
        <div class="row gx-lg-8 gx-xl-0 align-items-center">
          <div class="col-md-5 col-lg-4 offset-lg-1 d-none d-md-flex position-relative">
            ...
            <figure><img src="assets/img/photos/co1.png" srcset="./assets/img/photos/co1@2x.png 2x" alt="DevNation Community"></figure>
          </div>
          ...
          <div class="carousel owl-carousel gap-small" data-margin="0" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "3"}, "1400":{"items": "4"}}'>
            <div class="item">
              <div class="item-inner">
                <div class="card">
                  <div class="card-body">
                    <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te1.jpg" srcset="./assets/img/avatars/te1@2x.jpg 2x" alt="Member 1" />
            ...
            <div class="item">
              <div class="item-inner">
                <div class="card">
                  <div class="card-body">
                    <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te2.jpg" srcset="./assets/img/avatars/te2@2x.jpg 2x" alt="Member 2" />
            ...
            <div class="item">
              <div class="item-inner">
                <div class="card">
                  <div class="card-body">
                    <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te3.jpg" srcset="./assets/img/avatars/te3@2x.jpg 2x" alt="Member 3" />
            ...
            <div class="item">
              <div class="item-inner">
                <div class="card">
                  <div class="card-body">
                    <img class="rounded-circle w-15 mb-4" src="assets/img/avatars/te4.jpg" srcset="./assets/img/avatars/te4@2x.jpg 2x" alt="Member 4" />
      ...
      <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
            ...
            <figure class="rounded"><img src="assets/img/photos/about4.jpg" srcset="./assets/img/photos/about4@2x.jpg 2x" alt="DevNation Event"></figure>
          </div>
          <div class="col-lg-6">
    ...
    <div class="container py-13 py-md-15">
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            <img class="mb-4" src="assets/img/logo-light.png" srcset="./assets/img/logo-light@2x.png 2x" alt="DevNation Logo" />
            <p class="mb-4">© 2024 DevNation. <br class="d-none d-lg-block" />All rights reserved.</p>
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <address class="pe-xl-15 pe-xxl-17">123 Tech Avenue, Innovation City, IN 12345, India</address>
            <a href="mailto:info@devnation.org">info@devnation.org</a><br /> +91 98765 43210
          </div>
        </div>
        <div class="col-md-4 col-lg-3">
          <div class="widget">
